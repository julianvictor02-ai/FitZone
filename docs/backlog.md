...
| FZ-016 | Stornogebühren-Automatik (Berechnung/Abbuchung) | 3 | hypo | spec.md §7 (Später) | v1 nur Flag + manuelle Abwicklung. Regel bestätigt (Lisa 2026-07-04, §8 Frage 7): Gebühr = 50 % Kurspreis. **Blockiert**: „Kurspreis"/Preise nicht hinterlegt (§8 Frage 11 vertagt) → keine Auto-Berechnung möglich. |
...
| FZ-019 | Push-Benachrichtigung (realer Versand) | 2 | validated | spec.md §4 BR8, §8 F10 | Kanal entschieden (Lisa 2026-07-04): **Push aufs Handy**. Aktuell nur Stub (`lib/notify.ts`). Umsetzung offen (Web-Push/Infra) — eigener Task. |
